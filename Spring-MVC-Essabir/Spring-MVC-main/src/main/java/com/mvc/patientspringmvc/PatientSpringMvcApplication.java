...
@SpringBootApplication //class principal de l'application
public class PatientSpringMvcApplication {
    ...
    CommandLineRunner start(PatientRepository patientRepository) {
        return args -> {
            patientRepository.save(new Patient(null, "Hajar", new Date(), false, 11));
            patientRepository.save(new Patient(null, "Nada",new Date(),true,250));
            patientRepository.save(new Patient(null, "Oussama",new Date(),true,665));
            patientRepository.save(new Patient(null, "Ikhlas",new Date(),false,34));
